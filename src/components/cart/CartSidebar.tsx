...
export function ProductDetail({ product, onBack }: ProductDetailProps) {
  ...
  // --- Add to cart function like ProductCard ---
  const addToCart = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    button.classList.add('animate-pulse', 'bg-green-500', 'text-white');
    setTimeout(() => button.classList.remove('animate-pulse','bg-green-500','text-white'), 1000);
